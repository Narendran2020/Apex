...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r318.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r318.model, ctx_r318.index))("ngTemplateOutlet", ctx_r318.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r324); const ctx_r323 = ɵngcc0.ɵɵnextContext(2); return ctx_r323.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r326); const ctx_r325 = ɵngcc0.ɵɵnextContext(); return ctx_r325.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r326); const ctx_r327 = ɵngcc0.ɵɵnextContext(); return ctx_r327.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r326); const ctx_r328 = ɵngcc0.ɵɵnextContext(); return ctx_r328.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r326); const ctx_r329 = ɵngcc0.ɵɵnextContext(); return ctx_r329.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r319.editing)("title", ctx_r319.getDisplayValue(ctx_r319.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r319.getDisplayValue(ctx_r319.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r319.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r320.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r331 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r334 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r331[ctx_r334.displayBy], ctx_r334.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r331 = ctx_r338.$implicit;
    const index_r332 = ctx_r338.index;
    const last_r333 = ctx_r338.last;
    const ctx_r335 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r335.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r331, index_r332, last_r333));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r331)("ngSwitch", !!ctx_r330.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const item_r342 = ctx.$implicit; const ctx_r344 = ɵngcc0.ɵɵnextContext(); return ctx_r344.selectItem(item_r342); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const item_r342 = ctx.$implicit; const i_r343 = ctx.index; const ctx_r346 = ɵngcc0.ɵɵnextContext(); return ctx_r346.onRemoveRequested(item_r342, i_r343); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r347 = ɵngcc0.ɵɵnextContext(); return ctx_r347.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r348 = ɵngcc0.ɵɵnextContext(); return ctx_r348.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const i_r343 = ctx.index; const ctx_r349 = ɵngcc0.ɵɵnextContext(); return ctx_r349.onTagBlurred($event, i_r343); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const item_r342 = ctx.$implicit; const i_r343 = ctx.index; const ctx_r350 = ɵngcc0.ɵɵnextContext(); return ctx_r350.dragZone ? ctx_r350.onDragStarted($event, item_r342, i_r343) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const i_r343 = ctx.index; const ctx_r351 = ɵngcc0.ɵɵnextContext(); return ctx_r351.dragZone ? ctx_r351.onTagDropped($event, i_r343) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r352 = ɵngcc0.ɵɵnextContext(); return ctx_r352.dragZone ? ctx_r352.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const i_r343 = ctx.index; const ctx_r353 = ɵngcc0.ɵɵnextContext(); return ctx_r353.dragZone ? ctx_r353.onDragOver($event, i_r343) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r345); const ctx_r354 = ɵngcc0.ɵɵnextContext(); return ctx_r354.dragZone ? ctx_r354.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r342 = ctx.$implicit;
    const i_r343 = ctx.index;
    const ctx_r339 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r339.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r339.isTagValid)("disabled", ctx_r339.disable)("@animation", ctx_r339.animationMetadata)("hasRipple", ctx_r339.ripple)("index", i_r343)("removable", ctx_r339.removable)("editable", ctx_r339.editable)("displayBy", ctx_r339.displayBy)("identifyBy", ctx_r339.identifyBy)("template", !!ctx_r339.hasCustomTemplate() ? ctx_r339.templates.first : undefined)("draggable", ctx_r339.dragZone)("model", item_r342);
...
function TagInputComponent_div_6_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const error_r356 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(error_r356);
} }
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r341.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r341.errors);
} }
const _c3 = ["*"];
...
TagComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TagComponent, selectors: [["tag"]], viewQuery: function TagComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc2.NgSwitch, ɵngcc2.NgSwitchCase, ɵngcc2.NgIf, ɵngcc2.NgTemplateOutlet, DeleteIconComponent,
...
TagComponent = __decorate([ __metadata("design:paramtypes", [ElementRef,
        Renderer2,
        ChangeDetectorRef])
], TagComponent);
...
TagInputDropdown.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TagInputDropdown, selectors: [["tag-input-dropdown"]], contentQueries: function TagInputDropdown_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc3.Ng2Dropdown, ɵngcc3.Ng2DropdownMenu, ɵngcc2.NgForOf, ɵngcc3.Ng2MenuItem, ɵngcc2.NgSwitch, ɵngcc2.NgSwitchCase, ɵngcc2.NgSwitchDefault, ɵngcc2.NgTemplateOutlet], pipes: [HighlightPipe], encapsulation: 2 });
__decorate([
...
TagInputDropdown = __decorate([ __metadata("design:paramtypes", [Injector])
], TagInputDropdown);
...
TagInputComponent = __decorate([ __metadata("design:paramtypes", [Renderer2,
        DragProvider])
], TagInputComponent);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DeleteIconComponent, [{
        type: Component,
        args: [{
