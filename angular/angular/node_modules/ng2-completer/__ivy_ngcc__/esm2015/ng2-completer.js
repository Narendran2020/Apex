...
function CompleterListItemCmp_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const part_r282 = ctx.$implicit;
    const ctx_r281 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", part_r282.isMatch ? ctx_r281.matchClass : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(part_r282.text);
} }
...
function CompleterCmp_div_3_div_1_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r290 = ɵngcc0.ɵɵnextContext(3);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r290._textSearching);
} }
function CompleterCmp_div_3_div_1_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r291 = ɵngcc0.ɵɵnextContext(3);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r291._textNoResults);
} }
function CompleterCmp_div_3_div_1_div_3_div_2_img_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "img", 21);
} if (rf & 2) {
    const item_r293 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵpropertyInterpolate("src", item_r293.image, ɵngcc0.ɵɵsanitizeUrl);
} }
...
function CompleterCmp_div_3_div_1_div_3_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r293 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r293.image != "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r293.image === "");
} }
function CompleterCmp_div_3_div_1_div_3_completer_list_item_5_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r293 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r296 = ɵngcc0.ɵɵnextContext(3);
    ɵngcc0.ɵɵproperty("text", item_r293.description)("matchClass", ctx_r296.matchClass)("searchStr", ctx_r296.searchStr)("type", "description");
} }
...
function CompleterCmp_div_3_div_1_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowIndex_r294 = ctx.index;
    const ctx_r292 = ɵngcc0.ɵɵnextContext(3);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ctrRow", rowIndex_r294)("dataItem", item_r293);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r293.image || item_r293.image === "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c2, item_r293.image || item_r293.image === ""));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("text", item_r293.title)("matchClass", ctx_r292.matchClass)("searchStr", ctx_r292.searchStr)("type", "title");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r293.description && item_r293.description != "");
} }
function CompleterCmp_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const searchActive_r286 = ctx_r302.searching;
    const items_r285 = ctx_r302.results;
    const ctx_r289 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", searchActive_r286 && ctx_r289.displaySearching);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !searchActive_r286 && (!items_r285 || (items_r285 == null ? null : items_r285.length) === 0));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", items_r285);
} }
function CompleterCmp_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const items_r285 = ctx.results;
    const searchActive_r286 = ctx.searching;
    const isInitialized_r287 = ctx.searchInitialized;
    const isOpen_r288 = ctx.isOpen;
    const ctx_r284 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", isInitialized_r287 && isOpen_r288 && ((items_r285 == null ? null : items_r285.length) > 0 || ctx_r284.displayNoResults && !searchActive_r286 || searchActive_r286 && ctx_r284.displaySearching));
} }
...
LocalDataFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LocalDataFactory, factory: LocalDataFactory.ɵfac });
...
RemoteDataFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RemoteDataFactory, factory: RemoteDataFactory.ɵfac });
RemoteDataFactory = __decorate$1([ __metadata("design:paramtypes", [HttpClient])
], RemoteDataFactory);
...
CompleterService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CompleterService, factory: CompleterService.ɵfac });
CompleterService = __decorate$2([ __metadata$1("design:paramtypes", [LocalDataFactory,
        RemoteDataFactory // Using any instead of () => LocalData because of AoT errors
    ])
], CompleterService);
...
CtrCompleter.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CtrCompleter, selectors: [["", "ctrCompleter", ""]], outputs: { selected: "selected", highlighted: "highlighted", opened: "opened", dataSourceChange: "dataSourceChange" } });
__decorate$3([
    Output(),
...
CtrDropdown.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CtrDropdown, selectors: [["", "ctrDropdown", ""]], hostBindings: function CtrDropdown_HostBindings(rf, ctx) { if (rf & 1) {
...
CtrDropdown = __decorate$4([ __param(0, Host()),
...
CtrInput.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CtrInput, selectors: [["", "ctrInput", ""]], hostBindings: function CtrInput_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keyup", function CtrInput_keyup_HostBindingHandler($event) { return ctx.keyupHandler($event); })("paste", function CtrInput_paste_HostBindingHandler($event) { return ctx.pasteHandler($event); })("keydown", function CtrInput_keydown_HostBindingHandler($event) { return ctx.keydownHandler($event); })("blur", function CtrInput_blur_HostBindingHandler($event) { return ctx.onBlur($event); })("focus", function CtrInput_focus_HostBindingHandler($event) { return ctx.onfocus(); })("click", function CtrInput_click_HostBindingHandler($event) { return ctx.onClick($event); });
...
CtrInput = __decorate$5([ __param$1(0, Host()),
...
CtrList = __decorate$6([ __param$2(0, Host()),
...
CtrRow.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CtrRow, selectors: [["", "ctrRow", ""]], hostBindings: function CtrRow_HostBindings(rf, ctx) { if (rf & 1) {
...
CtrRow = __decorate$7([ __param$3(2, Host()),
...
CompleterCmp = __decorate$9([ __metadata$8("design:paramtypes", [CompleterService, ChangeDetectorRef])
], CompleterCmp);
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LocalDataFactory, [{
        type: Injectable
    }], null, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RemoteDataFactory, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.HttpClient }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CompleterService, [{
        type: Injectable
    }], function () { return [{ type: LocalDataFactory }, { type: RemoteDataFactory // Using any instead of () => LocalData because of AoT errors
     }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CtrCompleter, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CtrDropdown, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CtrInput, [{
        type: Directive,
        args: [{
                selector: "[ctrInput]"
            }]
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CtrList, [{
        type: Directive,
        args: [{
                selector: "[ctrList]"
            }]
